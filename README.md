...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/autoscrape-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/autoscrape-sdk/tags) |
| Python | `voxgig-sdk-autoscrape` | publish pending — [install from git tag](https://github.com/voxgig-sdk/autoscrape-sdk/tags) |
| PHP | `voxgig-sdk/autoscrape` | publish pending — [install from git tag](https://github.com/voxgig-sdk/autoscrape-sdk/tags) |
| Golang | `github.com/voxgig-sdk/autoscrape-sdk/go` | `go get github.com/voxgig-sdk/autoscrape-sdk/go@latest` |
| Ruby | `voxgig-sdk-autoscrape` | publish pending — [install from git tag](https://github.com/voxgig-sdk/autoscrape-sdk/tags) |
| Lua | `voxgig-sdk-autoscrape` | publish pending — [install from git tag](https://github.com/voxgig-sdk/autoscrape-sdk/tags) |
