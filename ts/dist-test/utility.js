...
function envOverride(m) {
    if ('TRUE' === process.env.AUTOSCRAPE_TEST_LIVE ||
        'TRUE' === process.env.AUTOSCRAPE_TEST_OVERRIDE) {
    ...
    m.AUTOSCRAPE_TEST_EXPLAIN = process.env.AUTOSCRAPE_TEST_EXPLAIN || m.AUTOSCRAPE_TEST_EXPLAIN;
    return m;
}
