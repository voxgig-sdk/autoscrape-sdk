...
(0, node_test_1.describe)('X402PaidDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-x402_paid', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-x402_paid', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOSCRAPE_TEST_X402_PAID_ENTID'];
...
//# sourceMappingURL=X402PaidDirect.test.js.map