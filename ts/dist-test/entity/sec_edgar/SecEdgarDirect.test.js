...
(0, node_test_1.describe)('SecEdgarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sec_edgar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sec_edgar', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOSCRAPE_TEST_SEC_EDGAR_ENTID'];
...
//# sourceMappingURL=SecEdgarDirect.test.js.map