...
(0, node_test_1.describe)('StockDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-stock_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-stock_data', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOSCRAPE_TEST_STOCK_DATA_ENTID'];
...
//# sourceMappingURL=StockDataDirect.test.js.map