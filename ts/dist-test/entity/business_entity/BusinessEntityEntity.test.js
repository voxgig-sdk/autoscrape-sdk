...
(0, node_test_1.describe)('BusinessEntityEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'business_entity.' + op, live))
                return;
        }
        ...
        let business_entity_ref01_data = Object.values(setup.data.existing.business_entity)[0];
        // LOAD
        const business_entity_ref01_ent = client.BusinessEntity();
        const business_entity_ref01_match_dt0 = {};
        const business_entity_ref01_data_dt0 = (await business_entity_ref01_ent.load(business_entity_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != business_entity_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/business_entity/BusinessEntityTestData.json');
    ...
    let idmap = transform(['business_entity01', 'business_entity02', 'business_entity03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BusinessEntityEntity.test.js.map