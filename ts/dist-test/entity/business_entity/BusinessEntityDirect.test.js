...
(0, node_test_1.describe)('BusinessEntityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AutoscrapeSDK({
    ...
    (0, node_test_1.test)('direct-load-business_entity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-business_entity', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AUTOSCRAPE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AutoscrapeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['AUTOSCRAPE_TEST_BUSINESS_ENTITY_ENTID'];
    ...
    const client = new __1.AutoscrapeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BusinessEntityDirect.test.js.map