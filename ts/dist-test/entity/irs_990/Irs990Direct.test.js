...
(0, node_test_1.describe)('Irs990Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-irs_990', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-irs_990', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOSCRAPE_TEST_IRS_990_ENTID'];
...
//# sourceMappingURL=Irs990Direct.test.js.map