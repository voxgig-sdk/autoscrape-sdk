...
(0, node_test_1.describe)('BuildingPermitDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-building_permit', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-building_permit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AUTOSCRAPE_TEST_BUILDING_PERMIT_ENTID'];
...
//# sourceMappingURL=BuildingPermitDirect.test.js.map