...
class AutoscrapeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutoscrapeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AutoscrapeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AutoscrapeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
