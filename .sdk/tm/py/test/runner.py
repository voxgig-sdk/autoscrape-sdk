...
class AutoscrapeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutoscrapeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AutoscrapeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AutoscrapeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
