...
// Autoscrape SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AutoscrapeTestFeature extends AutoscrapeBaseFeature
{
    ...
    public function init(AutoscrapeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AutoscrapeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AutoscrapeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AutoscrapeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AutoscrapeContext $ctx, $op, $args): array
    {
