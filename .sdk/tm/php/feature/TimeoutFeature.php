...
// Autoscrape SDK timeout feature
...
class AutoscrapeTimeoutFeature extends AutoscrapeBaseFeature
{
    ...
    private function _with_timeout(AutoscrapeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AutoscrapeContext $_ctx, float $ms): void
    {
        $client = $this->client;
