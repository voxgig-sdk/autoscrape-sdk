...
class AutoscrapeProxyFeature extends AutoscrapeBaseFeature
{
    ...
    public function init(AutoscrapeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AutoscrapeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
