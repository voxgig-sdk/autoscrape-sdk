...
// Autoscrape SDK clienttrack feature
...
class AutoscrapeClienttrackFeature extends AutoscrapeBaseFeature
{
    ...
    public function PostConstruct(AutoscrapeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Autoscrape-SDK';
