...
class AutoscrapeRbacFeature extends AutoscrapeBaseFeature
{
    ...
    private function _required(AutoscrapeContext $ctx): ?string
    {
    ...
    private function _reject(AutoscrapeContext $ctx, string $required): void
    {
    ...
    private function _track(AutoscrapeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
