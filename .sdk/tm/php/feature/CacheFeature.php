...
class AutoscrapeCacheFeature extends AutoscrapeBaseFeature
{
    ...
    private function _through(AutoscrapeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
