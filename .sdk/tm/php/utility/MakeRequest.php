...
// Autoscrape SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AutoscrapeMakeRequest
{
    public static function call(AutoscrapeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AutoscrapeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AutoscrapeResponse($fetched);
        } else {
