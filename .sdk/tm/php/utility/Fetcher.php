...
// Autoscrape SDK utility: fetcher

class AutoscrapeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AutoscrapeSDK/1.0)';
    ...
    public static function call(AutoscrapeContext $ctx, string $fullurl, array $fetchdef): array
    {
