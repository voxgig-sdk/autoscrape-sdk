...
// Autoscrape SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AutoscrapeTransformResponse
{
    public static function call(AutoscrapeContext $ctx): mixed
    {
        ...
        $transform = AutoscrapeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
