...
|---|---|---|
| `ts/` | @voxgig-sdk/autoscrape-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/autoscrape-sdk \
      --repository voxgig-sdk/autoscrape-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/autoscrape-sdk` shows it, and
`npm trust revoke @voxgig-sdk/autoscrape-sdk --id=<id>` removes it.
