...
// Autoscrape SDK utility: graphql
//
...
class AutoscrapeGraphql
{
    ...
    // equivalent.
    public static function body(AutoscrapeContext $ctx): mixed
    {
    ...
    public static function errors(AutoscrapeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
