...
// Autoscrape SDK idempotency feature
...
class AutoscrapeIdempotencyFeature extends AutoscrapeBaseFeature
{
    ...
    private function _mutating(AutoscrapeContext $ctx): bool
    {
