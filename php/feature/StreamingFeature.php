...
// Autoscrape SDK streaming feature
...
class AutoscrapeStreamingFeature extends AutoscrapeBaseFeature
{
    ...
    private function _iterate(AutoscrapeResult $result): \Generator
    {
    ...
    private function _streamable(AutoscrapeContext $ctx): bool
    {
