...
// Autoscrape SDK ratelimit feature
...
class AutoscrapeRatelimitFeature extends AutoscrapeBaseFeature
{
    ...
    private function _acquire(AutoscrapeContext $ctx): void
    {
    ...
    private function _track(AutoscrapeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
