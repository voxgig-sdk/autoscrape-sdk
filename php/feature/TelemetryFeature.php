...
// Autoscrape SDK telemetry feature
...
class AutoscrapeTelemetryFeature extends AutoscrapeBaseFeature
{
    ...
    private function _close(AutoscrapeContext $ctx, bool $ok): void
    {
