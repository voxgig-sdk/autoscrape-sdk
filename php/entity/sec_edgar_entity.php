...
// Autoscrape SDK SecEdgar entity
...
class SecEdgarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SecEdgarEntity($this->_client, $opts);
    }

    /**
     * @param SecEdgar|array $args SecEdgar data (assoc-array) to store.
     */
    ...
    /**
     * @return SecEdgar|array The current SecEdgar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SecEdgar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SecEdgar fields).
     */
    ...
    /**
     * Load a single SecEdgar.
     *
     * @param SecEdgarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SecEdgarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SecEdgar|array The loaded SecEdgar as an assoc-array at the
