...
// Autoscrape SDK StockData entity
...
class StockDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StockDataEntity($this->_client, $opts);
    }

    /**
     * @param StockData|array $args StockData data (assoc-array) to store.
     */
    ...
    /**
     * @return StockData|array The current StockData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StockData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StockData fields).
     */
    ...
    /**
     * Load a single StockData.
     *
     * @param StockDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StockDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StockData|array The loaded StockData as an assoc-array at the
