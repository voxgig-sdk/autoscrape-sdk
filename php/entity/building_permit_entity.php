...
// Autoscrape SDK BuildingPermit entity
...
class BuildingPermitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BuildingPermitEntity($this->_client, $opts);
    }

    /**
     * @param BuildingPermit|array $args BuildingPermit data (assoc-array) to store.
     */
    ...
    /**
     * @return BuildingPermit|array The current BuildingPermit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BuildingPermit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BuildingPermit fields).
     */
    ...
    /**
     * Load a single BuildingPermit.
     *
     * @param BuildingPermitLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BuildingPermitLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BuildingPermit|array The loaded BuildingPermit as an assoc-array at the
