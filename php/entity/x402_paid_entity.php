...
// Autoscrape SDK X402Paid entity
...
class X402PaidEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new X402PaidEntity($this->_client, $opts);
    }

    /**
     * @param X402Paid|array $args X402Paid data (assoc-array) to store.
     */
    ...
    /**
     * @return X402Paid|array The current X402Paid data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of X402Paid fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of X402Paid fields).
     */
    ...
    /**
     * Load a single X402Paid.
     *
     * @param X402PaidLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed X402PaidLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return X402Paid|array The loaded X402Paid as an assoc-array at the
