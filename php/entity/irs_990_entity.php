...
class Irs990Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Irs990Entity($this->_client, $opts);
    }

    /**
     * @param Irs990|array $args Irs990 data (assoc-array) to store.
     */
    ...
    /**
     * @return Irs990|array The current Irs990 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Irs990 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Irs990 fields).
     */
    ...
    /**
     * Load a single Irs990.
     *
     * @param Irs990LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed Irs990LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Irs990|array The loaded Irs990 as an assoc-array at the
