...
class X402PaidEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AUTOSCRAPE_TEST_X402_PAID_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function x402_paid_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AUTOSCRAPE_TEST_X402_PAID_ENTID");
