...
class AutoscrapeTestRunner
{
    ...
    {
        $live = self::getenv('AUTOSCRAPE_TEST_LIVE');
        $override = self::getenv('AUTOSCRAPE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AUTOSCRAPE_TEST_EXPLAIN');
...
class_alias('AutoscrapeTestRunner', 'Runner');
class_alias('AutoscrapeHelpers', 'Helpers');
