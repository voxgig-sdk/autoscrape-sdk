...
// Autoscrape SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AutoscrapeSDK::test)
...
{
    private const SDK_CLASS = 'AutoscrapeSDK';
    ...
    private const SDK_BASE = 'autoscrape_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../autoscrape_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
