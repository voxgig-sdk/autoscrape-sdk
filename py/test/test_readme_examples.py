# Autoscrape SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AutoscrapeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AutoscrapeSDK(...) and AutoscrapeSDK.test(...) become
#      AutoscrapeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "autoscrape_sdk"
_SDK_CLASS = "AutoscrapeSDK"
