...
class BusinessEntityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BusinessEntityEntity(self._client, opts)
    ...
    def data_get(self) -> BusinessEntity:
    ...
    def match_get(self) -> BusinessEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> BusinessEntity:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.BusinessEntity().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
