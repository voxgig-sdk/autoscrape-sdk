...
from autoscrape_sdk.autoscrape_types import (
    BuildingPermit,
...
class BuildingPermitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BuildingPermitEntity(self._client, opts)
    ...
    def data_get(self) -> BuildingPermit:
    ...
    def match_get(self) -> BuildingPermit:
    ...
    def load(self, reqmatch=None, ctrl=None) -> BuildingPermit:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.BuildingPermit().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
