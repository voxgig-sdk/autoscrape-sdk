...
type BuildingPermitEntity struct {
	name    string
	client  *core.AutoscrapeSDK
...
func NewBuildingPermitEntity(client *core.AutoscrapeSDK, entopts map[string]any) *BuildingPermitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BuildingPermitEntity) GetName() string { return e.name }
...
func (e *BuildingPermitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BuildingPermitEntity) Deleted() bool {
	return e.deleted
}


func (e *BuildingPermitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBuildingPermitEntity(e.client, opts)
}

func (e *BuildingPermitEntity) Data(args ...any) any {
...
func (e *BuildingPermitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BuildingPermit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BuildingPermitEntity) DataTyped(data ...BuildingPermit) BuildingPermit {
	if len(data) > 0 {
		return typedFrom[BuildingPermit](e.Data(asMap(data[0])))
	}
	return typedFrom[BuildingPermit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BuildingPermit (all fields
// optional at the wire level).
func (e *BuildingPermitEntity) MatchTyped(match ...BuildingPermit) BuildingPermit {
	if len(match) > 0 {
		return typedFrom[BuildingPermit](e.Match(asMap(match[0])))
	}
	return typedFrom[BuildingPermit](e.Match())
}
...
func (e *BuildingPermitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BuildingPermitEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BuildingPermitLoadMatch and returns an BuildingPermit. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BuildingPermitEntity) LoadTyped(reqmatch BuildingPermitLoadMatch, ctrl map[string]any) (BuildingPermit, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BuildingPermit{}, err
	}
	return typedFrom[BuildingPermit](res), nil
}



func (e *BuildingPermitEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BuildingPermitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BuildingPermitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BuildingPermitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BuildingPermitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
