...
func NewX402PaidEntity(client *core.AutoscrapeSDK, entopts map[string]any) *X402PaidEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *X402PaidEntity) GetName() string { return e.name }
...
func (e *X402PaidEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *X402PaidEntity) Deleted() bool {
	return e.deleted
}


func (e *X402PaidEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewX402PaidEntity(e.client, opts)
}

func (e *X402PaidEntity) Data(args ...any) any {
...
func (e *X402PaidEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an X402Paid; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *X402PaidEntity) DataTyped(data ...X402Paid) X402Paid {
	if len(data) > 0 {
		return typedFrom[X402Paid](e.Data(asMap(data[0])))
	}
	return typedFrom[X402Paid](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through X402Paid (all fields
// optional at the wire level).
func (e *X402PaidEntity) MatchTyped(match ...X402Paid) X402Paid {
	if len(match) > 0 {
		return typedFrom[X402Paid](e.Match(asMap(match[0])))
	}
	return typedFrom[X402Paid](e.Match())
}
...
func (e *X402PaidEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *X402PaidEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// X402PaidLoadMatch and returns an X402Paid. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *X402PaidEntity) LoadTyped(reqmatch X402PaidLoadMatch, ctrl map[string]any) (X402Paid, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return X402Paid{}, err
	}
	return typedFrom[X402Paid](res), nil
}



func (e *X402PaidEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *X402PaidEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *X402PaidEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *X402PaidEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *X402PaidEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
