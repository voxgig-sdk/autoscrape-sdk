...
type BusinessEntityEntity struct {
	name    string
...
func NewBusinessEntityEntity(client *core.AutoscrapeSDK, entopts map[string]any) *BusinessEntityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BusinessEntityEntity) GetName() string { return e.name }
...
func (e *BusinessEntityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BusinessEntityEntity) Deleted() bool {
	return e.deleted
}


func (e *BusinessEntityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBusinessEntityEntity(e.client, opts)
}

func (e *BusinessEntityEntity) Data(args ...any) any {
...
func (e *BusinessEntityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BusinessEntity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BusinessEntityEntity) DataTyped(data ...BusinessEntity) BusinessEntity {
	if len(data) > 0 {
		return typedFrom[BusinessEntity](e.Data(asMap(data[0])))
	}
	return typedFrom[BusinessEntity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BusinessEntity (all fields
// optional at the wire level).
func (e *BusinessEntityEntity) MatchTyped(match ...BusinessEntity) BusinessEntity {
	if len(match) > 0 {
		return typedFrom[BusinessEntity](e.Match(asMap(match[0])))
	}
	return typedFrom[BusinessEntity](e.Match())
}
...
func (e *BusinessEntityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BusinessEntityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BusinessEntityLoadMatch and returns an BusinessEntity. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BusinessEntityEntity) LoadTyped(reqmatch BusinessEntityLoadMatch, ctrl map[string]any) (BusinessEntity, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BusinessEntity{}, err
	}
	return typedFrom[BusinessEntity](res), nil
}



func (e *BusinessEntityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BusinessEntityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BusinessEntityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BusinessEntityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BusinessEntityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
