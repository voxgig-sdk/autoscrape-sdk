...
func NewSecEdgarEntity(client *core.AutoscrapeSDK, entopts map[string]any) *SecEdgarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SecEdgarEntity) GetName() string { return e.name }
...
func (e *SecEdgarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SecEdgarEntity) Deleted() bool {
	return e.deleted
}


func (e *SecEdgarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSecEdgarEntity(e.client, opts)
}

func (e *SecEdgarEntity) Data(args ...any) any {
...
func (e *SecEdgarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SecEdgar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SecEdgarEntity) DataTyped(data ...SecEdgar) SecEdgar {
	if len(data) > 0 {
		return typedFrom[SecEdgar](e.Data(asMap(data[0])))
	}
	return typedFrom[SecEdgar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SecEdgar (all fields
// optional at the wire level).
func (e *SecEdgarEntity) MatchTyped(match ...SecEdgar) SecEdgar {
	if len(match) > 0 {
		return typedFrom[SecEdgar](e.Match(asMap(match[0])))
	}
	return typedFrom[SecEdgar](e.Match())
}
...
func (e *SecEdgarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SecEdgarEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SecEdgarLoadMatch and returns an SecEdgar. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SecEdgarEntity) LoadTyped(reqmatch SecEdgarLoadMatch, ctrl map[string]any) (SecEdgar, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SecEdgar{}, err
	}
	return typedFrom[SecEdgar](res), nil
}



func (e *SecEdgarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SecEdgarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SecEdgarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SecEdgarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SecEdgarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
