...
func NewIrs990Entity(client *core.AutoscrapeSDK, entopts map[string]any) *Irs990Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Irs990Entity) GetName() string { return e.name }
...
func (e *Irs990Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Irs990Entity) Deleted() bool {
	return e.deleted
}


func (e *Irs990Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIrs990Entity(e.client, opts)
}

func (e *Irs990Entity) Data(args ...any) any {
...
func (e *Irs990Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Irs990; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Irs990Entity) DataTyped(data ...Irs990) Irs990 {
	if len(data) > 0 {
		return typedFrom[Irs990](e.Data(asMap(data[0])))
	}
	return typedFrom[Irs990](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Irs990 (all fields
// optional at the wire level).
func (e *Irs990Entity) MatchTyped(match ...Irs990) Irs990 {
	if len(match) > 0 {
		return typedFrom[Irs990](e.Match(asMap(match[0])))
	}
	return typedFrom[Irs990](e.Match())
}
...
func (e *Irs990Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Irs990Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Irs990LoadMatch and returns an Irs990. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Irs990Entity) LoadTyped(reqmatch Irs990LoadMatch, ctrl map[string]any) (Irs990, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Irs990{}, err
	}
	return typedFrom[Irs990](res), nil
}



func (e *Irs990Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Irs990Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Irs990Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Irs990Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Irs990Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
