...
func NewStockDataEntity(client *core.AutoscrapeSDK, entopts map[string]any) *StockDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StockDataEntity) GetName() string { return e.name }
...
func (e *StockDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StockDataEntity) Deleted() bool {
	return e.deleted
}


func (e *StockDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStockDataEntity(e.client, opts)
}

func (e *StockDataEntity) Data(args ...any) any {
...
func (e *StockDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StockData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StockDataEntity) DataTyped(data ...StockData) StockData {
	if len(data) > 0 {
		return typedFrom[StockData](e.Data(asMap(data[0])))
	}
	return typedFrom[StockData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StockData (all fields
// optional at the wire level).
func (e *StockDataEntity) MatchTyped(match ...StockData) StockData {
	if len(match) > 0 {
		return typedFrom[StockData](e.Match(asMap(match[0])))
	}
	return typedFrom[StockData](e.Match())
}
...
func (e *StockDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StockDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StockDataLoadMatch and returns an StockData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StockDataEntity) LoadTyped(reqmatch StockDataLoadMatch, ctrl map[string]any) (StockData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return StockData{}, err
	}
	return typedFrom[StockData](res), nil
}



func (e *StockDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StockDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StockDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StockDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StockDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
