...
const testSeed = `map[string]any{"entity": map[string]any{"building_permit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "business_entity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "irs_990": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sec_edgar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stock_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whoi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "x402_paid": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
