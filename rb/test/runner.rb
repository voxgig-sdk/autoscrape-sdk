...
module AutoscrapeTestRunner
  ...
  def self.env_override(m)
    live = getenv("AUTOSCRAPE_TEST_LIVE")
    override = getenv("AUTOSCRAPE_TEST_OVERRIDE")
    ...
    explain = getenv("AUTOSCRAPE_TEST_EXPLAIN")
    m["AUTOSCRAPE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AutoscrapeTestRunner
Helpers = AutoscrapeHelpers
Vs = VoxgigStruct
