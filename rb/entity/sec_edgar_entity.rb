...
class SecEdgarEntity
  ...
  def make
    opts = @_entopts.dup
    SecEdgarEntity.new(@_client, opts)
  end
  ...
  # @return [SecEdgar, Hash] the current SecEdgar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SecEdgar fields)
  def match_get
  ...
  #
  # @param reqmatch [SecEdgarLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.SecEdgar.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [SecEdgar, Hash] the loaded SecEdgar; raises AutoscrapeError on failure
