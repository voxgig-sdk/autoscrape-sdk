...
class StockDataEntity
  ...
  def make
    opts = @_entopts.dup
    StockDataEntity.new(@_client, opts)
  end
  ...
  # @return [StockData, Hash] the current StockData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StockData fields)
  def match_get
  ...
  #
  # @param reqmatch [StockDataLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StockData.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StockData, Hash] the loaded StockData; raises AutoscrapeError on failure
