...
class Irs990Entity
  ...
  # @return [Irs990, Hash] the current Irs990 data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Irs990 fields)
  def match_get
  ...
  #
  # @param reqmatch [Irs990LoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Irs990.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Irs990, Hash] the loaded Irs990; raises AutoscrapeError on failure
