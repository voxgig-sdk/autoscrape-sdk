...
class BuildingPermitEntity
  ...
  def make
    opts = @_entopts.dup
    BuildingPermitEntity.new(@_client, opts)
  end
  ...
  # @return [BuildingPermit, Hash] the current BuildingPermit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BuildingPermit fields)
  def match_get
  ...
  #
  # @param reqmatch [BuildingPermitLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.BuildingPermit.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [BuildingPermit, Hash] the loaded BuildingPermit; raises AutoscrapeError on failure
