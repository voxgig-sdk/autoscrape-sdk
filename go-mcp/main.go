// Command Autoscrape-mcp is an MCP server exposing the Autoscrape
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Autoscrape_list  — list records of an entity
//	Autoscrape_load  — load a single record of an entity
//
