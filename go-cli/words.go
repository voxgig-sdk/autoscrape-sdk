...
func registerSDKWords(r *eng.Registry, client *sdk.AutoscrapeSDK) {
...
func runOp(client *sdk.AutoscrapeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
