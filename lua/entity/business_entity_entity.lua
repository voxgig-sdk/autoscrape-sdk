...
local BusinessEntityEntity = {}
BusinessEntityEntity.__index = BusinessEntityEntity


function BusinessEntityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BusinessEntityEntity)
  self._name = "business_entity"
  self._client = client
...
function BusinessEntityEntity:get_name()
  return self._name
end


function BusinessEntityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BusinessEntityEntity.new(self._client, opts)
end
...
function BusinessEntityEntity:mark_deleted()
  self._deleted = true
end


function BusinessEntityEntity:deleted()
  return true == self._deleted
end


function BusinessEntityEntity:data_set(args)
  if args ~= nil then
...
function BusinessEntityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BusinessEntityEntity:match_set(args)
  if args ~= nil then
...
function BusinessEntityEntity:match_get()
...
function BusinessEntityEntity:stream(action, args, callopts)
...
---@param reqmatch BusinessEntityLoadMatch
---@param ctrl? table
---@return BusinessEntity
---@return string? err
function BusinessEntityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BusinessEntityEntity:_run_op(ctx, post_done)
  local utility = self._utility
