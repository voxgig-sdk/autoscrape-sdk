...
local SecEdgarEntity = {}
SecEdgarEntity.__index = SecEdgarEntity


function SecEdgarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SecEdgarEntity)
...
function SecEdgarEntity:get_name()
  return self._name
end


function SecEdgarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SecEdgarEntity.new(self._client, opts)
end
...
function SecEdgarEntity:mark_deleted()
  self._deleted = true
end


function SecEdgarEntity:deleted()
  return true == self._deleted
end


function SecEdgarEntity:data_set(args)
  if args ~= nil then
...
function SecEdgarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SecEdgarEntity:match_set(args)
  if args ~= nil then
...
function SecEdgarEntity:match_get()
...
function SecEdgarEntity:stream(action, args, callopts)
...
---@param reqmatch SecEdgarLoadMatch
---@param ctrl? table
---@return SecEdgar
---@return string? err
function SecEdgarEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SecEdgarEntity:_run_op(ctx, post_done)
  local utility = self._utility
