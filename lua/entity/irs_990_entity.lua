...
local Irs990Entity = {}
Irs990Entity.__index = Irs990Entity


function Irs990Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Irs990Entity)
  self._name = "irs_990"
  self._client = client
...
function Irs990Entity:get_name()
  return self._name
end


function Irs990Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Irs990Entity.new(self._client, opts)
end
...
function Irs990Entity:mark_deleted()
  self._deleted = true
end


function Irs990Entity:deleted()
  return true == self._deleted
end


function Irs990Entity:data_set(args)
  if args ~= nil then
...
function Irs990Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Irs990Entity:match_set(args)
  if args ~= nil then
...
function Irs990Entity:match_get()
...
function Irs990Entity:stream(action, args, callopts)
...
---@param reqmatch Irs990LoadMatch
---@param ctrl? table
---@return Irs990
---@return string? err
function Irs990Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Irs990Entity:_run_op(ctx, post_done)
  local utility = self._utility
