...
describe("Irs990Direct", function()
  it("should direct-load-irs_990", function()
    local setup = irs_990_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-irs_990", setup.live and "live" or "unit")
...
function irs_990_direct_setup(mockres)
