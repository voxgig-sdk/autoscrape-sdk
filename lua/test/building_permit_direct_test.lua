...
describe("BuildingPermitDirect", function()
  it("should direct-load-building_permit", function()
    local setup = building_permit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-building_permit", setup.live and "live" or "unit")
...
function building_permit_direct_setup(mockres)
