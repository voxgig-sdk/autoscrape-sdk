...
describe("StockDataDirect", function()
  it("should direct-load-stock_data", function()
    local setup = stock_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-stock_data", setup.live and "live" or "unit")
...
function stock_data_direct_setup(mockres)
