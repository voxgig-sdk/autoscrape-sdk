...
describe("BusinessEntityDirect", function()
  it("should direct-load-business_entity", function()
    local setup = business_entity_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-business_entity", setup.live and "live" or "unit")
...
function business_entity_direct_setup(mockres)
