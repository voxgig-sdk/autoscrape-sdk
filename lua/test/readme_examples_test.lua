...
local SDK_MODULE = "autoscrape_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["building_permit"] = { ["test01"] = { id = "test01" } }, ["business_entity"] = { ["test01"] = { id = "test01" } }, ["irs_990"] = { ["test01"] = { id = "test01" } }, ["sec_edgar"] = { ["test01"] = { id = "test01" } }, ["stock_data"] = { ["test01"] = { id = "test01" } }, ["whoi"] = { ["test01"] = { id = "test01" } }, ["x402_paid"] = { ["test01"] = { id = "test01" } } } }'
