...
describe("SecEdgarDirect", function()
  it("should direct-load-sec_edgar", function()
    local setup = sec_edgar_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sec_edgar", setup.live and "live" or "unit")
...
function sec_edgar_direct_setup(mockres)
