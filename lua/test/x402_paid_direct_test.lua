...
describe("X402PaidDirect", function()
  it("should direct-load-x402_paid", function()
    local setup = x402_paid_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-x402_paid", setup.live and "live" or "unit")
...
function x402_paid_direct_setup(mockres)
